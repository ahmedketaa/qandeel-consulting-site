...
const navItems = [
  {
    ...
    submenu: [
      ...
      "وزارة التوطين والموارد البشرية",
      "خدمات كاتب العدل",
    ...
    <header className="sticky top-0 z-50 bg-light/90 backdrop-blur">
      ...
      <div className="border-b border-secondary bg-light">
        ...
        >
          ...
          <div className="flex items-center gap-4">
            ...
            <button   onClick={openModal}  className="hover:text-primary transition">
              تواصل معنا
            </button>
            <span className="text-secondary">|</span>
            {/* <button className="flex items-center gap-1 hover:text-primary transition">
              <span className="inline-block w-4 h-3 bg-gradient-to-r from-red-600 via-white to-blue-700 border border-dark/40" />
              <span>English</span>
            </button> */}
          </div>
      ...
      <div className="bg-dark text-light">
        ...
        >
          ...
          {/* Desktop CTA + space for logo if needed */}
